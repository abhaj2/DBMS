...
ALTER TABLE LOAN_ACCOUNTS
 ...
 (1002,'S.P.SHARMA',50000.00,48,10.00,'2008-03-22'),
 (1003,'K.P. JAIN',300000.00,36,NULL,'2004-08-3'),
 (1004,'M.P YADAV',800000.00,60,10.00,'2008-05-12'),
 (1005,'S.P SHINA',200000.00,36,12.50,'2010-03-1'),
 (1006,'P.SHARMA',700000.00,60,12.20,'2008-05-6'),
 (1007,'K.S DHALL',50000.00,48,NULL,'2008-05-03');

UPDATE LOAN_ACCOUNTS SET INT_RATE=11.50             
...
DELETE  FROM LOAN_ACCOUNTS WHERE START_DATE < '2008-01-01';
 ...
 DELETE FROM  LOAN_ACCOUNTS WHERE CUST_NAME LIKE 'K%'; #DELETE ALL RECORDS STARTING WITH K
 
 SELECT *FROM LOAN_ACCOUNTS WHERE INSTALLMENTS<40; #DISPLAY DETAILS OF LOAN HAVING INSTALLMENTS<40
...
SELECT ACCNO, LOAN_AMOUNT FROM LOAN_ACCOUNTS WHERE START_DATE<'2009-04-01'; 
 ...
 SELECT *FROM LOAN_ACCOUNTS WHERE CUST_NAME LIKE '%SHARMA';
 
  SELECT *FROM LOAN_ACCOUNTS WHERE CUST_NAME LIKE '%A';
