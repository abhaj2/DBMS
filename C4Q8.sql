...
INSERT INTO BRANCH(BID,BNAME,BCITY,ASSETS) VALUES
(1,'MAIN','C1',10000),
(2,'B2','C2',20000),
(3,'B3','C3',30000),
(4,'B4','C4',40000),
...
SELECT CUSTOMER.CID,CNAME,BNAME FROM BRANCH,CUSTOMER,DEPOSITOR,ACCOUNTS WHERE CUSTOMER.CID=DEPOSITOR.CID AND DEPOSITOR.ACCNO=ACCOUNTS.ACCNO AND
 ACCOUNTS.BID=1 GROUP BY ACCOUNTS.BID HAVING COUNT(ACCOUNTS.BID)>=2;

SELECT CUSTOMER.CID,CNAME,ACCOUNTS.ACCNO,BCITY FROM ACCOUNTS,BRANCH,DEPOSITOR,CUSTOMER WHERE BRANCH.BID=ACCOUNTS.BID AND
 ACCOUNTS.ACCNO=DEPOSITOR.ACCNO AND DEPOSITOR.CID=CUSTOMER.CID AND BRANCH.BCITY='C3'GROUP BY DEPOSITOR.CID
 HAVING COUNT(DISTINCT BRANCH.BID)=(SELECT COUNT(BID) FROM BRANCH WHERE BCITY='C3');
